...
-----
Vthn = 0.67V
KPn = 92uA/V^2} -50 -390 0 0 0.4 0.4 {}
N 180 -190 180 -90 {
lab=GND}
N 30 -190 140 -190 {
lab=Vgs}
...
C {devices/vsource.sym} 30 -130 0 0 {name=VGS1 value="dc 1.1 ac 1m sin(1.1 1m 1k 0 0 0)"}
C {devices/gnd.sym} 180 -90 0 0 {name=l1 lab=GND}
C {devices/vsource.sym} -50 -130 0 0 {name=VDD value=3}
