...
C {devices/vsource.sym} 30 -130 0 0 {name=VGS1 value="dc 1.15 ac 1m"}
...
C {devices/pmos4.sym} 420 -190 0 0 {name=M2 model=P_1u w=30u l=2u del=0 m=1}
C {devices/vsource.sym} 290 -130 0 0 {name=VGS2 value="dc 3.8 ac 1m"}
C {devices/gnd.sym} 290 -90 0 0 {name=l4 lab=GND}
C {devices/lab_wire.sym} 360 -190 0 0 {name=p3 sig_type=std_logic lab=Vgs2}
