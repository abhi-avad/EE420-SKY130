...
+rbps    = 15           rbdb    = 15           rbsb    = 15           ngcon   = 1   
"}
C {devices/nmos4.sym} 390 -230 0 0 {name=M4 model=N_1u w=10u l=2u del=0 m=1}
C {devices/isource.sym} 410 -350 0 0 {name=I1 value=1n}
C {devices/vsource.sym} 410 -120 0 0 {name=VSB value=0 }
C {devices/gnd.sym} 410 -80 0 0 {name=l1 lab=GND}
C {devices/gnd.sym} 460 -210 0 0 {name=l2 lab=GND}
C {devices/lab_wire.sym} 380 -280 0 0 {name=p1 sig_type=std_logic lab=VD}
C {devices/lab_wire.sym} 410 -170 0 0 {name=p2 sig_type=std_logic lab=VS}
