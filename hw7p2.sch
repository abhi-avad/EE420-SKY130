...
+rbps    = 15           rbdb    = 15           rbsb    = 15           ngcon   = 1   
"}
C {devices/nmos4.sym} 470 -110 0 0 {name=M3 model=N_1u w=10u l=2u del=0 m=1}
C {devices/lab_wire.sym} 180 -370 0 0 {name=p2 sig_type=std_logic lab=VDD}
C {devices/nmos4.sym} 260 -110 0 1 {name=M2 model=N_1u w=10u l=2u del=0 m=1}
C {devices/res.sym} 240 -320 0 0 {name=R1
value=300k
footprint=1206
device=resistor
m=1}
C {devices/res.sym} 490 -320 0 0 {name=R2
value=300k
footprint=1206
device=resistor
m=1}
C {devices/vsource.sym} -30 -330 0 0 {name=V1 value=5 savecurrent=false}
C {devices/lab_wire.sym} 290 -160 0 0 {name=p1 sig_type=std_logic lab=VD2}
C {devices/lab_wire.sym} 490 -160 0 0 {name=p3 sig_type=std_logic lab=VD5}
C {devices/vsource.sym} 370 -110 1 0 {name=VOS value=0 savecurrent=false}
C {devices/gnd.sym} 360 -60 0 0 {name=l2 lab=GND}
C {devices/ammeter.sym} 490 -240 0 0 {name=Vmeas savecurrent=true spice_ignore=0}
C {devices/ammeter.sym} 240 -240 0 1 {name=Vmeas1 savecurrent=true spice_ignore=0}
