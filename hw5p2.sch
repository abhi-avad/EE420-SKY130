...
N 250 -180 310 -180 {
lab=Vout}
C {devices/vsource.sym} 130 -170 0 0 {name=VG value="dc 3.75 sin(3.75 5m 1k 0 0 0)"}
C {devices/vsource.sym} 360 -310 0 0 {name=VDD value=5 }
C {devices/gnd.sym} 250 -70 0 0 {name=l5 lab=GND}
...
+rbps    = 15           rbdb    = 15           rbsb    = 15           ngcon   = 1   
"}
C {devices/pmos4.sym} 230 -230 0 0 {name=M1 model=P_1u w=30u l=2u del=0 m=1}
C {devices/lab_wire.sym} 310 -180 0 0 {name=p2 sig_type=std_logic lab=Vout}
C {devices/res.sym} 250 -120 0 0 {name=R1
value=100k
footprint=1206
device=resistor
m=1}
C {devices/gnd.sym} 130 -140 0 0 {name=l1 lab=GND}
