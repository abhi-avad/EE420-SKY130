...
+rbps    = 15           rbdb    = 15           rbsb    = 15           ngcon   = 1   
"}
C {devices/pmos4.sym} 520 -320 0 0 {name=M1 model=P_1u w=30u l=2u del=0 m=1}
C {devices/pmos4.sym} 370 -320 0 1 {name=M2 model=P_1u w=30u l=2u del=0 m=1}
C {devices/nmos4.sym} 330 -180 0 0 {name=M3 model=N_1u w=10u l=2u del=0 m=1}
C {devices/nmos4.sym} 560 -180 0 1 {name=M4 model=N_1u w=10u l=2u del=0 m=1}
C {devices/lab_wire.sym} 290 -180 0 0 {name=p1 sig_type=std_logic lab=VGS1}
C {devices/lab_wire.sym} 470 -370 0 0 {name=p2 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 480 -130 0 0 {name=p3 sig_type=std_logic lab=VS12}
C {devices/lab_wire.sym} 620 -180 0 0 {name=p4 sig_type=std_logic lab=VGS2}
C {devices/lab_wire.sym} 540 -240 0 0 {name=p5 sig_type=std_logic lab=VD24}
C {devices/lab_wire.sym} 350 -230 0 0 {name=p6 sig_type=std_logic lab=VD13}
