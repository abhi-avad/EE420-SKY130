...
C {devices/gnd.sym} 180 -190 3 0 {name=l1 lab=GND}
...
C {devices/gnd.sym} 540 -190 3 0 {name=l4 lab=GND}
...
C {devices/pmos4.sym} 860 -270 0 0 {name=M3 model=P_1u w=30u l=2u del=0 m=1}
